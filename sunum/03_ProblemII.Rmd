...
- Bazı araştırmada problem cümlesi ve hipoteze ilişkin ayrı bir başlık bulunmaz. 

- araştırmanın türü ve amacından yola çıkılarak problem cümlesi ve hipotezlerden biri tercih edilmelidir. 
--
...
|---|---|
| her çalışmada araştırma problemi yazılabilir. | 2 değişken ve bunların arasındaki ilişkilerin incelendiği çalışmalar için yazılabilir |
| soru cümlesi biçimindedir | yargı cümlesidir |
| her hipotez problem cümlesine dönüştürülebilir | yalnızca uygun yapıya sahip araştırma problemleri hipoteze dönüştürülebilir| 
| genelde nitel çalışmalarda tercih edilir Çünkü bu araştırmalar doğası gereği hipotez yazmayı uygun değildir| çoğunlukla niceler araştırmalarda Özellikle de denetlerde desenlerde kullanılır|
