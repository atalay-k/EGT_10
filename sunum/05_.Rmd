...
- Nitel araştırmalar için nasıl ne şekilde sorularına cevap arar.
...
.center[
- **Öğrencilerin sosyal medya kullanım alışkanları cinsiyete göre değişmekte midir?**
]
...
- tanılayıcı amaç taşıyan araştırmalardır. 

- Üniversite öğrencilerin sosyal medyada geçirdikleri süre ne kadardır?
- Güvenlik görevlilerinin eğitim düzeyleri nasıl dağılmaktadır?
...
- Bu araştırmalarda bağımsız değişekn kategoriktit.  
...
- **Öğrencilerin sosyal medya kullanma alışkınları  bölümlere göre farklılık göstermekte midir?**
...
- **üniversite öğrencilerin sosyla medyada geçridikleri zaman ile genel başarı puanları arasıda nasıl bir ilişki vardır?**
