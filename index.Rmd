...
## `r advdate(mon, 2)`:[Bilimsel Araştırma Temel Kavramlar](sunum/03.html)
...
## `r advdate(mon, 4)`:[Ölçmede Temel Kavramlar](sunum/02.html)
-   Ölçme Nedir?
-   Ölçüm Nedir?
-   Ölçek Nedir?
-   Ölçek Türleri
