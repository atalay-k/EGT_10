...
-   `r emo::ji("notebook")`  **50% Derse Katılım ve Ödevler**
    ...
    - Ödev II - 10 puan - literatur taraması ve problem durumu
...
## `r advdate(mon, 5)`: [Örnekleme Yöntemleri](sunum/06.html)
...
## `r advdate(mon, 6)`: [Veri Toplama Araçları I](sunum/08.html)
